<template>
  <!-- 
  Solo per spiegare i grafici contenuti in DashboardView.vue
      ...
      <TabView>
        <TabPanel header="Per esercizio">
          <div class="chart-container">
            ...
            <div class="col-4">
              <chart-component
                title="Intensità"
                description="Andamento dell'intensità per le diverse alzate principali."
                :data="dataA5"
                :options="optionA5"
                :width="400"
                :height="300"
            ...
            <div class="col-4">
              <chart-component
                title="IRT"
                description="Andamento dell'IRT per le diverse alzate principali."
                :data="dataA6"
                :options="optionA6"
                :width="400"
                :height="300"
        ...
        <TabPanel header="Totali">
          <div class="chart-container">
            ...
            <div class="col-4">
              <chart-component
                title="A: Panca - Andamento parametri nel mesociclo"
                description="Andamento dell'intensità, volume e IRT nel mesociclo di riferimento."
                :data="dataA"
                :options="optionA"
                :width="400"
                :height="300"
            ...
            <div class="col-4">
              <chart-component
                title="A2: Stacco - Andamento parametri nel mesociclo"
                description="Andamento dell'intensità, volume e IRT nel mesociclo di riferimento."
                :data="dataA2"
                :options="optionA"
                :width="400"
            ...
            <div class="col-4">
              <chart-component
                title="A3: Squat - Andamento parametri nel mesociclo"
                description="Andamento dell'intensità, volume e IRT nel mesociclo di riferimento."
                :data="dataA3"
                :options="optionA"
                :width="400"
      ...
      <TabView>
        <TabPanel header="Per esercizio">
          <div class="chart-container">
            ...
            <div class="col-6">
              <chart-component
                title="D: Andamento Carico di allenamento per esercizio"
                type="bar"
            ...
            <div class="col-6">
              <chart-component
                title="D2: Andamento Carico di allenamento per esercizio"
                type="bar"
                description="Questo grafico mostra l'andamento del Volume x Intensità per singolo esercizio"
                :data="dataD2"
                :options="optionD2"
        ...
        <TabPanel header="Per seduta">
          <div class="chart-container">
            ...
            <div class="col-6">
              <chart-component
                title="B: Carico di allenamento (bar)"
                description="Andamento dell'intensità x volume nel corso del mesociclo per seduta."
                :data="dataB"
                :options="optionB"
                :width="400"
                :height="300"
            ...
            <div class="col-6">
              <chart-component
                title="C: Carico di allenamento (line)"
                description="Andamento dell'intensità relativa x volume nel corso del mesociclo per seduta."
                :data="dataC"
                :options="optionC"
                :width="400"
                :height="300"
        ...
        <TabPanel header="Per settimana">
          <div class="chart-container">
            ...
            <div class="col-6">
              <chart-component
                title="B: Andamento Carico di allenamento"
                description="Andamento dell'intensità x volume nel corso del mesociclo per seduta."
                :data="dataB2"
                :options="optionB2"
                :width="400"
            ...
            <div class="col-6">
              <chart-component
                title="C: Andamento Carico di allenamento"
                description="Andamento dell'intensità relativa x volume nel corso del mesociclo per seduta."
                :data="dataC2"
                :options="optionC2"
                :width="400"
            ...
            <div class="chart-container">
              ...
              <div class="col-6">
                <chart-component
                  ...
                  description="Andamento dell'1RM versus peso corporeo."
                  :data="dataF"
                  :options="optionF"
                  :width="400"
                  :height="300"
              ...
              <div class="col-3">
                <chart-component
                  title="Volume per diversi livelli di intensità"
                  description="Volume di allenamento per vari livelli di intensità relativa durante le settimane."
                  type="doughnut"
                  :data="dataE3"
                  :options="optionsE3"
                  :width="400"
              ...
              <div class="col-3">
                <chart-component
                  title="Volume nelle settimane"
                  description="Volume di allenamento per durante le settimane."
                  type="doughnut"
                  :data="dataE4"
                  :options="optionsE4"
                  :width="400"
...
const renderChartE3 = () => {
  if (
    !doughnutChartE3.value ||
    !(doughnutChartE3.value instanceof HTMLCanvasElement)
  ) {
...
const renderChartE4 = () => {
  if (
    !doughnutChartE4.value ||
    !(doughnutChartE4.value instanceof HTMLCanvasElement)
  ) {
    console.error("Missing or invalid reference to canvas element.");
    return;
  }
...
onMounted(async () => {
  ...
  console.log(
    computeVolumeInDateRange(
      dataInput.registeredFitness,
      new Date("2023-07-25"),
      new Date("2023-07-28"),
    ),
  );
