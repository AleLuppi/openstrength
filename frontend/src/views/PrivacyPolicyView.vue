      ...
      <body class="c16 doc-content">
        ...
        <p class="c7">
          <span class="c0"
            ...
            raccolti automaticamente durante l&#39;uso di questa
            Applicazione.<br />Se non diversamente specificato, tutti i Dati
            richiesti da questa Applicazione sono obbligatori. Se l&rsquo;Utente
            ...
            liberi di astenersi dal comunicare tali Dati, senza che ci&ograve;
            abbia alcuna conseguenza sulla disponibilit&agrave; del Servizio o
            sulla sua operativit&agrave;.<br />Gli Utenti che dovessero avere
            dubbi su quali Dati siano obbligatori sono incoraggiati a contattare
            il Titolare.<br />L&rsquo;eventuale utilizzo di Cookie - o di altri
            strumenti di tracciamento - da parte di questa Applicazione o dei
            titolari dei servizi terzi utilizzati da questa Applicazione ha la
            finalit&agrave; di fornire il Servizio richiesto dall&#39;Utente,
            oltre alle ulteriori finalit&agrave; descritte nel presente
        ...
        <p class="c7">
          <span class="c0"
            ...
            viene effettuato mediante strumenti informatici e/o telematici, con
            modalit&agrave; organizzative e con logiche strettamente correlate
            alle finalit&agrave; indicate. Oltre al Titolare, in alcuni casi,
        ...
        <p class="c7">
          <span class="c0"
            ...
            Dati Personali dell&rsquo;Utente potrebbero essere trasferiti in un
            paese diverso da quello in cui l&rsquo;Utente si trova. Per ottenere
            ulteriori informazioni sul luogo del trattamento l&rsquo;Utente
            pu&ograve; fare riferimento alla sezione relativa ai dettagli sul
        ...
        <p class="c7">
          <span class="c0"
            ...
            conservati per un periodo pi&ugrave; lungo a causa di eventuali
        ...
        <p class="c7">
          <span class="c0"
            ...
            interessi (o quelli di Utenti o di terze parti), individuare
            eventuali attivit&agrave; dolose o fraudolente, nonch&eacute; per le
            seguenti finalit&agrave;: Accesso agli account su servizi terzi,
            Registrazione ed autenticazione, Hosting ed infrastruttura backend,
            Gestione contatti e invio di messaggi, Funzionalit&agrave; sociali,
            Monitoraggio dell&#39;infrastruttura, Test di performance di
            contenuti e funzionalit&agrave; (A/B testing), Statistica, Gestione
            dei database di Utenti, Gestione delle richieste di supporto e
            contatto, Gestione delle attivit&agrave; relative alla
            produttivit&agrave;, Gestione dei tag, Contattare l&#39;Utente,
            Gestione dei pagamenti, Registrazione ed autenticazione fornite
            direttamente da questa Applicazione, Servizi di piattaforma e
            hosting, Raccolta delle preferenze relative alla privacy,
            Visualizzazione di contenuti da piattaforme esterne e Vendita di
        ...
        <p class="c7">
          <span class="c0"
            ...
            sezione &ldquo;Dettagli sul trattamento dei Dati
        ...
        <p class="c12">
          <span class="c0"
            ...
            dettagli sul percorso di navigazione dell&rsquo;Utente verso e
        ...
        <p class="c12">
          <span class="c0"
            ...
            funzionalit&agrave;, la manutenzione o la risoluzione di
            problemi.<br />I Dati Personali trattati dipendono dalle
            caratteristiche e della modalit&agrave; d&rsquo;implementazione di
            questi servizi, che per loro natura filtrano l&rsquo;attivit&agrave;
        ...
        <p class="c12">
          <span class="c0"
            ...
            servizi di registrazione e di autenticazione potrebbero essere
            forniti con l&rsquo;ausilio di terze parti. Qualora questo avvenga,
            questa Applicazione potr&agrave; accedere ad alcuni Dati conservati
            dal servizio terzo usato per la registrazione o
            ...
            profilazione; per saperne di pi&ugrave;, si prega di fare
        ...
        <p class="c12">
          <span class="c0"
            ...
            Authentication pu&ograve; utilizzare fornitori di identit&agrave; di
            terze parti e salvare le informazioni sulla propria
            piattaforma.</span
          >
        </p>
        <p class="c12">
        ...
        <p class="c12">
          <span class="c0"
            ...
            pu&ograve; consultare questa privacy policy per avere una
            descrizione dettagliata degli altri strumenti usati dal
            Titolare.</span
          >
        </p>
        <p class="c15"><span class="c0">&nbsp;</span></p>
        ...
        <p class="c12">
          <span class="c0"
            ...
            impostazioni sulla pubblicit&agrave; disponibili sul proprio
            telefonino, oppure seguire le istruzioni applicabili a Firebase
            eventualmente presenti all&rsquo;interno di questa privacy
            policy.</span
          >
        </p>
        <p class="c12">
        ...
        <p class="c7 c11">
          ...
          ><span class="c10"
            ...
            utilizzare le App e i Siti. In caso di differenze tra una traduzione
            e la versione italiana, prevale la versione italiana. Pertanto,
            continuando a utilizzare i nostri Siti, accetti e riconosci di aver
            compreso i termini di questo documento in una delle lingue in cui
        ...
        <p class="c7 c11">
          <span class="c0"
            ...
            raccogliamo informazioni quando l&rsquo;utente crea un account sui
        ...
        <p class="c7 c11">
          <span class="c0"
            ...
            relative all&rsquo;utilizzo dei Siti, qualunque messaggio che
            l&rsquo;utente pubblichi sui Siti (recensioni o altro), o quando ci
            contatta o ci fornisce opinioni via e-mail o con qualunque altro
            mezzo di comunicazione. Quando l&rsquo;utente visita i nostri Siti o
            utilizza i nostri Servizi tramite i Siti o l&rsquo;App, gli viene
            richiesto di fornire informazioni personali, incluso il nome e i
            dettagli di contatto. Raccogliamo informazioni tecniche dal telefono
            mobile o computer dell&rsquo;utente, ad esempio il suo sistema
            operativo, il tipo di dispositivo e di connessione, e
        ...
        <p class="c7 c11">
          <span class="c0"
            ...
            delle informazioni dell&rsquo;utente se: dovremo trattare le
            informazioni al fine di fornirgli i servizi che ha richiesto o per
            stipulare un contratto; abbiamo il suo consenso; abbiamo un
            legittimo interesse per trattare i suoi dati; o se abbiamo
            l&rsquo;obbligo giuridico di farlo. Se l&rsquo;utente vuole
            utilizzare i Servizi, dovremo necessariamente trattare i suoi dati
            per dargli accesso alle rispettive sezioni dei Siti, per fornire i
            Servizi richiesti, per riscuotere i pagamenti effettuati
            dall&rsquo;utente, per contattare quest&rsquo;ultimo in relazione a
            problematiche relative ai Servizi. Vengono altresi&#768; trattati i
            dati dell&rsquo;utente quando abbiamo una legittima ragione per
            farlo, come ad esempio:<br /><br />- per migliorare
            l&rsquo;efficacia e la qualita&#768; del servizio<br />- per
            adattare i contenuti mostrati sui Siti al profilo
            dell&rsquo;utente<br />- per contattare l&rsquo;utente in merito
            alle sue opinioni e commenti circa i nostri Servizi e per avvisarlo
            in caso di importanti cambiamenti o sviluppi ai Siti o ai nostri
            servizi<br />- per analizzare l&rsquo;attivita&#768;
            dell&rsquo;utente sui Siti cosi&#768; da poter gestire, supportare,
            migliorare e sviluppare la nostra attivita&#768;, per scopi
            statistici e di analisi e per aiutarci a prevenire le frodi;<br />-
            per eseguire i termini del nostro contratto e di ogni altro accordo
            in essere con l&rsquo;utente, e per l&rsquo;esercizio di, o la
            difesa contro, azioni legali e per proteggere i diritti di
            OpenStrength<br />- per utilizzare commenti e opinioni
            dell&rsquo;utente relativi ai nostri Servizi sui Siti in ogni altro
            materiale commerciale o pubblicitario.<br /><br />Analizzeremo anche
            i dati sull&rsquo;utilizzo dei Servizi da parte dell&rsquo;utente
            (Profilazione) al fine di creare profili relativi personalizzati.
            Laddove utilizziamo un interesse legittimo come base per il
            trattamento delle informazioni personali dell&rsquo;utente,
            eseguiamo delle verifiche per garantire che il nostro trattamento
            sia necessario e che i suoi fondamentali diritti alla riservatezza
            siano prevalenti rispetto ai nostri legittimi interessi.
            L&rsquo;utente puo&#768; ottenere ulteriori informazioni circa
            queste verifiche contattandoci agli indirizzi di cui sopra. Nei casi
            in cui siamo vincolati dalla legge, potremmo usare le informazioni
            dell&rsquo;utente al fine di creare un registro dei tuoi ordini e
            adempiere a qualunque altro obbligo di legge o requisito normativo a
        ...
        <p class="c7 c11">
          <span class="c0"
            ...
            autorizzati, trattamenti illeciti, perdite accidentali, distruzione
            e danneggiamenti. Ogni utente che intende utilizzare i nostri
            Servizi, sceglie una password o una credenziale che gli consente di
            accedere ad alcune sezioni dei Siti; l&rsquo;utente ha la
            responsabilit&agrave; di conservare tale password o credenziale in
            maniera confidenziale. Sebbene adottiamo misure per proteggere le
            informazioni dei nostri utenti, la trasmissione di informazioni via
            Internet non &egrave; completamente sicura; per questo motivo non
            possiamo garantire la sicurezza dei dati trasmessi a noi; qualsiasi
        ...
        <p class="c7 c11">
          <span class="c0"
            ...
            cellulari, e modificando quindi tali impostazioni per questa
            Applicazione, per alcune o per tutte le applicazioni presenti sul
            dispositivo in questione.<br />Gli Utenti devono essere consapevoli
            che la disabilitazione delle notifiche push pu&ograve; influire
        ...
        <ul class="c4 lst-kix_list_3-0 start">
          <li class="c9 li-bullet-0">
            <span class="c0"
              ...
              un&rsquo;altra delle basi giuridiche specificate di seguito, fino
              a quando l&rsquo;Utente non si opponga (&ldquo;opt-out&rdquo;) a
              tale trattamento. Ci&ograve; non &egrave; tuttavia applicabile
        ...
        <p class="c7">
          <span class="c0"
            ...
            previsto da un contratto o necessario per concludere un
            contratto.</span
          >
        </p>
        <h3 class="c1">
        ...
        <ul class="c4 lst-kix_list_4-0 start">
          ...
          <li class="c9 li-bullet-0">
            <span class="c0"
              ...
              documento o contattando il Titolare.</span
            >
          </li>
        </ul>
        <p class="c7">
          <span class="c0"
            ...
            revocato. Inoltre, il Titolare potrebbe essere obbligato a
        ...
        <p class="c7">
          <span class="c0"
            ...
            internazionale o costituita da due o pi&ugrave; paesi, come ad
            esempio l&rsquo;ONU, nonch&eacute; in merito alle misure di
        ...
        <p class="c7">
          <span class="c10"
            ...
            del Titolare, gli Utenti hanno diritto ad opporsi al trattamento per
        ...
        <p class="c7">
          <span class="c10"
            ...
            alcuna motivazione. Qualora gli Utenti si oppongano al trattamento
            per finalit&agrave; di marketing diretto, i Dati Personali non sono
            pi&ugrave; oggetto di trattamento per tali finalit&agrave;. Per
            scoprire se il Titolare tratti Dati con finalit&agrave; di marketing
            diretto gli Utenti possono fare riferimento alle rispettive sezioni
        ...
        <p class="c7">
          <span class="c0"
            ...
            previste dalla legge. Eventuali rettifiche, cancellazioni o
            limitazioni del trattamento saranno comunicate dal Titolare a
            ciascuno dei destinatari, se esistenti, a cui sono stati trasmessi i
            Dati Personali, salvo che ci&ograve; si riveli impossibile o
            implichi uno sforzo sproporzionato. Il Titolare comunica
        ...
        <p class="c7">
          <span class="c0"
            ...
            questa Applicazione o dei Servizi connessi da parte
            dell&rsquo;Utente.<br />L&rsquo;Utente dichiara di essere
        ...
        <p class="c7">
          <span class="c0"
            ...
            questa Applicazione nonch&eacute;, qualora tecnicamente e legalmente
            ...
            data di ultima modifica indicata in fondo.<br /><br />Qualora le
            modifiche interessino trattamenti la cui base giuridica &egrave; il
            consenso, il Titolare provveder&agrave; a raccogliere nuovamente il
